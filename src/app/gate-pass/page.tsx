            ...
            <main className="container mx-auto px-4 py-8">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="card shadow-elevated">
                        <div className="mb-8">
                            <h1 className="text-4xl font-bold text-gray-900 mb-3 tracking-tight">{content.title}</h1>
                        ...
                        {success && (
                            <div className="mb-6 p-4 bg-success-50 border-2 border-success-200 rounded-xl text-success-700" role="alert">
                                <div className="flex items-center gap-2">
                                    <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex gap-4 pt-4">
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="btn btn-primary flex-1 text-base py-3 shadow-lg hover:shadow-xl transition-all"
